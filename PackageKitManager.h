...
private:
  static void InstallProgressCallback(PkProgress *progress, PkProgressType type, gpointer user_data);
  static void InstallFinishCallback(GObject *object, GAsyncResult *res, gpointer user_data);

  static void GetPackagesProgressCallback(PkProgress *progress, PkProgressType type, gpointer user_data);
  static void GetPackagesFinishCallback(GObject *object, GAsyncResult *res, gpointer user_data);
